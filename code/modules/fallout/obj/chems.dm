...
/obj/item/weapon/reagent_containers/pill/patch/healingpowder
	...
	list_reagents = list("omnizine" = 15, "salglu_solution" = 10, "morphine" = 1.6, "musclestimulant" = 8) // added morphine to the mix to prevent stacking a bunch of healing powders together, and to add the drowsiness drawback from FO2.
