...
/obj/machinery/vending/trader/brotherhoodsupplies
	name = "Brotherhood Supplies"
	desc = "Automated Quartermaster & Secure Storage System"
	product_ads = "An advanced pre-war storage system for military equipment, designed around a conveyor to bring items up from undergrounds storage containers, to ensure the safety of the equipment contained within."
	icon = 'icons/obj/machines/heavy_lathe.dmi'
	icon_state = "h_lathe"
	icon_deny = "h_lathe_leave"
	products = list(/obj/item/weapon/gun/energy/laser/rifle/tri = 1,/obj/item/weapon/gun/energy/laser/laer = 1,/obj/item/weapon/gun/energy/plasma = 2,/obj/item/weapon/gun/energy/plasma/pistol = 3,/obj/item/weapon/gun/energy/laser/gatling = 1,/obj/item/weapon/gun/energy/laser/rcw = 2,/obj/item/weapon/gun/energy/laser/pistol = 8,/obj/item/weapon/gun/energy/laser/rifle = 8,/obj/item/weapon/gun/energy/laser/rifle/aer13 = 2,/obj/item/weapon/grenade/syndieminibomb/concussion/frag = 12,/obj/item/weapon/grenade/syndieminibomb/concussion = 12,/obj/item/weapon/reagent_containers/pill/patch/supstimpak = 20,/obj/item/weapon/reagent_containers/pill/patch/medx = 20,/obj/item/weapon/reagent_containers/pill/patch/radaway = 20,/obj/item/weapon/reagent_containers/pill/patch/radx = 20,/obj/item/weapon/reagent_containers/pill/patch/psycho = 10,/obj/item/stack/sheet/metal = 500,/obj/item/stack/sheet/glass = 500)
	armor = list(melee = 100, bullet = 100, laser = 100, energy = 100, bomb = 100, bio = 100, rad = 100, fire = 100, acid = 100)
	resistance_flags = INDESTRUCTIBLE
	
/obj/machinery/vending/trader/enclavesupplies
	name = "Enclave Supplies"
	desc = "Automated Quartermaster & Secure Storage System"
	product_ads = "An advanced pre-war storage system for military equipment, designed around a conveyor to bring items up from underground storage containers, to ensure the safety of the equipment contained within."
	icon = 'icons/obj/machines/heavy_lathe.dmi'
	icon_state = "h_lathe"
	icon_deny = "h_lathe_leave"
